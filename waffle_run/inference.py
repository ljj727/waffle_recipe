...
parser.add_argument('--model_name', type=str, default='Iwest_PeopleDet_v1.0.0', help='Waffle Model Hub Name.')
parser.add_argument('--source', type=str, default='/home/ljj/bg', help='Dataset file path.')
